...
public class ForumTestSuite {
    ...
    public void testAddPost() {
        ...
        String expectedPost = "Hello everyone, this is my first contribution here!";
        String postAsItIs = forumUser.getPost(0).getPostBody();

        //Then
        Assert.assertEquals(1, forumUser.getPostsQuantity());
        Assert.assertEquals(expectedPost, postAsItIs);
    }
